...
var gameOverButton, gameOverImg; 
...
function draw() {
  ...
  if (gameState===PLAY){
   ...
   console.log(kangaroo.y)
    ...
    gameOverButton = createSprite(width/2, height/2-100);
    gameOverButton.addImage("over", gameOverImg);
  ...
  if(score >= 5){
    ...
    stroke(3);
    fill ("black");
    text("Congradulations!!! YoU wOn ThE gAmE!", 70, 200);
